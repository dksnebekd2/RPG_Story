...
'마을 회장 선거'를 배경으로, 피실험자가 후보 NPC(Wolfgang Schulz)의 공약과 행동을 직접 선택하면 나머지 NPC들의 여론이 어떻게 갈리는지 관찰했다. 비교 대상 후보는 Abigail Chen(경쟁 후보자)으로 고정했다. 아래는 6명 중 상반된 결과를 보인 두 사례다.
